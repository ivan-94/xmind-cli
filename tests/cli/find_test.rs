...
#[test]
fn find_json_query_id_equality_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_id_inequality_returns_non_matching_ids() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_id_in_returns_list_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
            "tests/fixtures/xmind/minimal.xmind",
            "--query",
            "id in [\"topic-payment\", \"topic-missing\"]",
            "--json",
        ])
        .output()
        .expect("find command runs");
...
#[test]
fn find_json_query_path_equality_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_path_inequality_returns_non_matching_paths() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_path_starts_with_returns_descendants() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
    ...
    assert_eq!(body["result"]["matches"][0]["id"], "topic-q2");
    assert_eq!(body["result"]["matches"][1]["id"], "topic-payment");
}

#[test]
fn find_json_query_path_contains_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_path_in_returns_list_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_note_exists_returns_topics_with_notes() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_note_contains_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_note_equality_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
            "tests/fixtures/xmind/metadata.xmind",
            "--query",
            "note = \"Supports card payments and refund workflows.\"",
            "--json",
        ])
        .output()
        .expect("find command runs");
...
#[test]
fn find_json_query_note_inequality_returns_non_matching_notes() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_depth_greater_than_returns_deeper_topics() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_depth_greater_or_equal_returns_matching_depth() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_depth_less_than_returns_shallow_topics() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_depth_less_or_equal_returns_matching_depth() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_depth_equality_returns_exact_depth() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_depth_in_returns_list_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_children_count_equality_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_children_count_inequality_returns_non_matching_counts() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_children_count_greater_than_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_children_count_greater_or_equal_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_children_count_less_than_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_children_count_less_or_equal_returns_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_children_count_in_returns_list_matches() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_or_accepts_either_condition() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
            "tests/fixtures/xmind/minimal.xmind",
            "--query",
            "title = \"Payment\" or title = \"Missing\"",
            "--json",
        ])
        .output()
        .expect("find command runs");
...
#[test]
fn find_json_query_not_inverts_condition() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
...
#[test]
fn find_json_query_parentheses_group_expression() {
    let output = Command::cargo_bin("xmind")
        .expect("xmind binary is built for CLI tests")
        .args([
            "find",
            "tests/fixtures/xmind/minimal.xmind",
            "--query",
            "title = \"Payment\" and (depth = 1 or depth = 2)",
            "--json",
        ])
        .output()
        .expect("find command runs");
